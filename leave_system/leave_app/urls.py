...
urlpatterns = [
    ...
    path('create_manager/', create_manager, name='create_manager'),  # Add this line
    path('create_employee/', create_employee, name='create_employee'),  # Add this line
    path('submit_leave/', submit_leave_request, name='submit_leave_application'),
    path('leave-requests/', leave_request_list, name='leave_request_list'),  # Add this line
